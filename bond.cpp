...
atomIndices0_0_h[0] = {0, 1};
atomIndices0_0_h[1] = {1, 0};
...
energyBuffer_h[0] = 0.0;
energyBuffer_h[1] = 0.0;
...
cgh.parallel_for(
sycl::nd_range<3>(sycl::range<3>(1, 1, 2), sycl::range<3>(1, 1, 2)),
[=](sycl::nd_item<3> item_ct1) {
computeBondedForces(forceBuffer, energyBuffer, posq, atomIndices0_0,
params, item_ct1, stream_ct1);
});
});
